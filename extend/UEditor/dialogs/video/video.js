...
(function(){
    ...
    function insertSingle(){
        ...
        if(/^<iframe/.test(url)){
            ...
            /^[1-9]+[.]?\d*$/g.test( width.value ) ? newIframe.setAttribute("width",width.value) : newIframe.setAttribute("width",634);
            /^[1-9]+[.]?\d*$/g.test( height.value ) ? newIframe.setAttribute("height",height.value) : newIframe.setAttribute("height",400);
